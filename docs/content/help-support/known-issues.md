...
{{% notice style="note" title="GitHub Issue for Further Information & Discussion" icon="code-branch" %}}
...
{{% notice style="note" title="Other Related GitHub Issues" icon="code-branch" %}}
